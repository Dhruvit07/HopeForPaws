...
<html lang="en">
<head>
<title>Best Pets an Animals and pets Category Bootstrap Responsive website Template | Web Icons :: w3layouts</title>
				...
				<div class="container">   
					<div class="agile_header_grid"> 
						<div class="header-mdl agileits-logo"> 
							<h1><a href="index.php">Best Pets</a></h1>
						</div>
								...
								<ul class="nav navbar-nav cl-effect-16">
									...
									<li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pages <span class="caret"></span></a>
										<ul class="dropdown-menu">
											<li><a href="icons.php" class="active" data-hover="Web Icons">Web Icons</a></li>
	...
	<div class="codes icons main-grid-border">
		<div class="container"> 
			<div class="grid_3 grid_4 w3_agileits_icons_page">
				<div class="icons">   
					<h3 class="agileits-title w3title2">Font Awesome Icons</h3> 
					<section id="new">
			...
			<div class="grid_3 grid_4">   
				<h3 class="agileits-title w3title2">Bootstrap Glyphicons</h3>
