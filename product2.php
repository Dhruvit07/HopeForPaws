    ...
    <div class="container">
        ...
        <div class="agile_gallery_grids" id="container">
            ...
            while ($product = $products->fetch_object()) { ?>
                ...
                <?php
                require 'helper/baseurl.php';
                $imageUrl = $base_url . $product->p_image;
                ?>

                <div class="col-sm-4 col-xs-4 agile_gallery_grid"
                     style="  padding:0px; margin:15px; border: none;  width : 300px;  border-radius: 10px;">

                    <form method="post" action="cart.php">
                        <div class="card"
                             style="  padding:0px; background-color: #fff; border: none; overflow:hidden;  width : 300px;  border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
                            ...
                            <div class="w3ls_gallery_grid">
                                <div class="image-container">
                                    ...
                                    <a href="#" class="lsb-preview wthree_p_grid mg-fluid rounded thumbnail-image"
                                       data-lsb-group="header" style="border-radius:10px">

                                        <!--                                        <img src="images/3.jpg" alt=" " class="img-responsive" style="border-radius:10px; height: 300px; object-fit: cover;"/>-->
                            ...
                            <div class="product-detail-container p-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4 class="dress-name"><?php echo $product->p_name; ?></h4>
                                    <div class="d-flex flex-column mb-2"><span
                                                class="new-price"> ₹ <?php echo $product->p_price; ?></span>
                                        <small class="old-price text-right">₹ <?php echo $product->p_price; ?></small>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-1">
                                    ...
                                    <span class="buy">
                                    <input type="number" style="margin-right:5px" name="quantity" min="1"
                                           max="10" value="1" size="2"/>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body modal-spa">
                            ...
                            <p>Donec fringilla lacus eu pretium rutrum. Cras aliquet congue ullamcorper. Etiam mattis
                                eros eu
                                ullamcorper volutpat. Proin ut dui a urna efficitur varius. uisque molestie cursus mi et
                                congue
                                consectetur adipiscing elit cras rutrum iaculis enim, Lorem ipsum dolor sit amet, non
                                convallis
                                felis mattis at. Maecenas sodales tortor ac ligula ultrices dictum et quis urna. Etiam
                                pulvinar
                                metus neque, eget porttitor massa vulputate in.<br> Fusce lacus purus, pulvinar ut
                                lacinia id,
                                sagittis eu mi. Vestibulum eleifend massa sem, eget dapibus turpis efficitur at. Aliquam
                                viverra
                                quis leo et efficitur. Nullam arcu risus, scelerisque quis interdum eget, fermentum
                                viverra
                                turpis. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis
                                voluptatibus
                                maiores alias consequatur aut At vero eos </p>
                        </div>
                    </div>
                </div>
            </div>
