...
?>
    ...
    <div class="container">
        <table class="table" style="float: left; border: 1px solid black; margin-top: 25px;">
            ...
            $uid = $_SESSION['u_id'];
            $counter = 0;
            $transactionSql = "SELECT * FROM `adoption` JOIN pet_category ON pet_category.pt_id = adoption.pet_id WHERE u_id = '$uid'";
