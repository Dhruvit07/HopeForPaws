                ...
                <form action="payment.php" method="post">
                    ...
                    <div class="row">
                        <div class="col-50">
                            ...
                            <input required type="hidden" name="price" value="<?php echo $price; ?>" />
                            <label for="fname"><i class="fa fa-user"></i> Full Name</label>
                            <input required type="text" id="fname" name="name" value="<?php echo $row['u_name'];  ?>" readonly>
                            <label for="email"><i class="fa fa-envelope"></i> Email</label>
                            <input required type="text" id="email" name="email" value="<?php echo $row['u_email'];  ?>" readonly>
                    ...
                    <input required type="submit" name="submit" value="Continue to checkout" class="btn">
                </form>
            </div>
        </div>
        <div class="col-25">
