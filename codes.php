...
<html lang="en">
<head>
<title>Best Pets an Animals and pets Category Bootstrap Responsive website Template | Short Codes :: w3layouts</title>
								...
								<ul class="nav navbar-nav cl-effect-16">
									...
									<li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pages <span class="caret"></span></a>
										<ul class="dropdown-menu">
											...
											<li><a href="codes.php" class="active" data-hover="Short Codes">Short Codes</a></li>
										</ul>
									</li> 
